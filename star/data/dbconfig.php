...
define('G5_MYSQL_USER', 'dkskcka1');
define('G5_MYSQL_PASSWORD', 'dydrkf0802@');
define('G5_MYSQL_DB', 'dkskcka1');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'star_');

define('G5_TOKEN_ENCRYPTION_KEY', 'e3f7de6e65253c04a0a0b283dabe7690'); // 토큰 암호화에 사용할 키
